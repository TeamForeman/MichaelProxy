...
//   let res = http.get(`http://localhost:3000/api/more/listings/${id}`);
//   check(res, {
...
// export default function() {
//   const id = Math.floor(Math.random() * (10000000 - 9900000) + 9900000);
//   let res = http.get(`http://localhost:3000/api/more/users/${id}/favorites`);
//   check(res, {
//     "success": (r) => r.status == 200
//   });
//   sleep(1);
...
export default function() {
  const id = Math.floor(Math.random() * (10000000 - 9900000) + 9900000);
  let res = http.post(`http://localhost:3000/api/more/favorites`, {
